...
public class TicTacToe implements TicTacToeLagrer {
	...
	public char getCurrentPlayer() {
		...
		if (count == 0 || count == 2 || count == 4 || count == 6 || count == ?? {
			return 'x';
		}
		else {
			return 'o';
